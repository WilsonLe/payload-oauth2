...
- Use mocked external-provider integration for authorize + callback happy paths; use live provider tests only for env-gated token/userinfo smoke with one-time auth codes.
